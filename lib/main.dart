...
class _MainNavigationState extends State<MainNavigation> {
  ...
  @override Widget build(BuildContext context) {
    ...
    return Scaffold(body: Row(children: [
      if (isT) Container(width: 80, color: const Color(0xFF161B22), child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
        IconButton(icon: Icon(Icons.home, color: _idx==0?Colors.blueAccent:Colors.grey, size: 30), onPressed: ()=>setState(()=>_idx=0)),
        const SizedBox(height: 40),
        IconButton(icon: Icon(Icons.person, color: _idx==2?Colors.blueAccent:Colors.grey, size: 30), onPressed: ()=>setState(()=>_idx=2)),
      ])),
