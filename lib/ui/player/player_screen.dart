...
class _LiveGoPlayerState extends State<LiveGoPlayer> {
  ...
  @override Widget build(BuildContext context) => Scaffold(backgroundColor: Colors.black, body: ready ? Center(child: AspectRatio(aspectRatio: _v!.value.aspectRatio, child: VideoPlayer(_v!))) : const Center(child: CircularProgressIndicator()));
}
