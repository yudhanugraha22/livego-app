...
class _LivegoPlayerState extends State<LivegoPlayer> {
  ...
  @override Widget build(BuildContext context) {
    return Scaffold(backgroundColor: Colors.black, body: ready ? Center(child: AspectRatio(aspectRatio: _v!.value.aspectRatio, child: VideoPlayer(_v!))) : const Center(child: CircularProgressIndicator()));
  }
}
