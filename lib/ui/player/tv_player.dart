...
class TVPlayer extends StatelessWidget {
  ...
  final String title;
  const TVPlayer({super.key, required this.controller, required this.title});
  ...
  Widget build(BuildContext context) {
    return Positioned(
      ...
      child: Container(
        ...
        child: Column(
          children: [
            VideoProgressIndicator(controller, allowScrubbing: true, colors: const VideoProgressColors(playedColor: Colors.pinkAccent)),
            ...
            Row(
              ...
              children: [
                ...
                TVButton(
                  ...
                  child: Icon(controller.value.isPlaying ? Icons.pause : Icons.play_arrow, size: 50, color: Colors.white),
                ),
