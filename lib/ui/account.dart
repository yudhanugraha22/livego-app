...
class _AccountPageState extends State<AccountPage> {
  ...
  _load() async { final p = await SharedPreferences.getInstance(); setState(() => drm = p.getString('drm') ?? "Auto"); }
  ...
  @override Widget build(BuildContext context) {
    return Scaffold(backgroundColor: const Color(0xFF0D1117), body: ListView(padding: const EdgeInsets.all(15), children: [
      ...
      _group("KOLEKSI", [ _item(Icons.history, "Riwayat Tontonan", "Paten", (){}), _item(Icons.favorite, "Favorit Saya", "Paten", (){}) ]),
    ]));
  }
