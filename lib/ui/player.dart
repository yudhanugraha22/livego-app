...
class _PlayerPageState extends State<PlayerPage> {
  ...
  _init() async {
    final res = await LiveApi.fetch("/api/v2/video?category_p=${widget.source}&id=${widget.id}&chapterId=1&lang=id");
    if (res != null) {
