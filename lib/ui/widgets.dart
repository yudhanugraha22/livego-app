      ...
      child: GestureDetector(
        ...
        child: AnimatedContainer(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(color: _isF ? Colors.cyanAccent : Colors.transparent, width: 3),
            boxShadow: _isF ? [BoxShadow(color: Colors.cyanAccent.withOpacity(0.5), blurRadius: 15)] : [],
          ),
