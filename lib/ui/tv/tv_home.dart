  ...
  @override Widget build(BuildContext context) {
    return Scaffold(backgroundColor: Colors.black, body: Row(children: [
      ...
      Expanded(child: Column(children: [
        SizedBox(height: 60, child: ListView(scrollDirection: Axis.horizontal, children: ["Melolo","FreeReels","FlickReels","RapidTV"].map((p)=>Padding(padding: const EdgeInsets.all(10), child: TVButton(onTap: (){ plat=p.toLowerCase(); _f(); }, child: Container(padding: const EdgeInsets.symmetric(horizontal: 30), alignment: Alignment.center, decoration: BoxDecoration(color: plat==p.toLowerCase()?Colors.deepPurple:Colors.white10, borderRadius: BorderRadius.circular(10)), child: Text(p))))).toList())),
