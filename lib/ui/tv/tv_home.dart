...
class TVHome extends ConsumerWidget {
  ...
  @override Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(backgroundColor: const Color(0xFF05070D), body: Row(children: [
      Container(width: 80, color: const Color(0xFF161B22), child: Column(mainAxisAlignment: MainAxisAlignment.center, children: const [Icon(Icons.home, color: Color(0xFF00D9FF), size: 30), SizedBox(height: 40), Icon(Icons.person, color: Colors.grey, size: 30)])),
