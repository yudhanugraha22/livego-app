  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(child: Column(children: [
        ...
        bn.when(data: (d)=>d==null?const SizedBox():_bannerUI(context, d, selP), loading: ()=>const SizedBox(height: 200), error: (_,__)=>const SizedBox()),
