...
class AccountScreen extends StatelessWidget {
  ...
  @override Widget build(BuildContext context) {
    return Scaffold(backgroundColor: const Color(0xFF05070D), body: ListView(padding: const EdgeInsets.all(15), children: [
      ...
      _g("PENGATURAN SYSTEM", [ _i(Icons.settings, "Navigasi", "Otomatis"), _i(Icons.lock, "Widevine DRM", "Auto"), _i(Icons.layers, "Sumber Data", "24 API") ]),
  ...
  Widget _i(IconData i, String t, String s) => TVButton(onTap: (){}, child: ListTile(leading: Icon(i, color: const Color(0xFF00D9FF)), title: Text(t, style: const TextStyle(fontSize: 14)), subtitle: Text(s, style: const TextStyle(fontSize: 11)), trailing: const Icon(Icons.chevron_right)));
}
