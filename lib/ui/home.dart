...
class _HomePageState extends State<HomePage> {
  List ds = []; bool load = true; String selS = "melolo";
  ...
  _init() async {
    ...
    setState(() {
      activeApis = all.where((api) {
        bool isDefOn = ["Melolo", "FreeReels", "FlickReels", "RapidTV"].contains(api);
        return p.getBool('api_$api') ?? isDefOn;
      }).toList();
  ...
  @override Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Column(children: [
        ...
        // Barisan API Dinamis (Hanya yang berstatus ON)
